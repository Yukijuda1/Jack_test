...
private Properties props = new Properties(); 
 ...
 public void send(String receiveMail,String username,String code,String location) throws UnsupportedEncodingException, MessagingException {
...
//	    message.setRecipient(MimeMessage.RecipientType.CC, new InternetAddress("15067148656@163.com", "liuxiaoran", "UTF-8"));
	    ...
	    message.setSubject("借阅成功！", "UTF-8");

	    // 5. Content: 邮件正文（可以使用html标签）（内容有广告嫌疑，避免被邮件服务器误认为是滥发广告以至返回失败，请修改发送内容）
	    message.setContent("用户:"+username+"<br />您的验证码为:"+"<span color='red'>"+code+"</span><br />书的位置:"+location, "text/html;charset=UTF-8");
	    // 6. 设置发件时间
