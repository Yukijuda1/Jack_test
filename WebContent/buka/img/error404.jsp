		...
		<div class="head-wrap">
			...
			<div class="head-nav">
				...
				<div class="nav-lists">
                    ...
                    <a href="${pageContext.request.contextPath}/mySpace.jsp" title="个人中心" class="nav-btn  active ">
                        个人中心
                    </a>
               </div>
				<nav class="head-nav-right-banner">
					<a href="${pageContext.request.contextPath}/query.jsp" title="布卡投稿平台" target="_blank" class="tougao">
						<span class="icon"></span>详细搜索</a>
