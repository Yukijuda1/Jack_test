...
<div class="user_read box_shadow" style="top: 173px;">
    <ul>
        <li class="select">
        	<a href="${pageContext.request.contextPath}/mySpace.jsp">会员基础信息</a></li>
        	<li><a href="${pageContext.request.contextPath}/business.jsp">事务信息</a></li>
	...
	<div class="manga_con box_shadow mar_bot">
           ...
           <div class="td_main minheight">
                 ...
                 <div class="ap_form">
                 	<!--内容-->
              <form action="${pageContext.request.contextPath}/authority" method="post">
         <div class="ap_input clearfix">
        <label class="ap_type fl" for="td_contact">管理员：</label>
          <select name="manager">
          <option disabled="disabled">请选择管理员</option>
          ...
          <div class="ap_input clearfix">
             <label class="ap_type fl" for="td_contact">联系方式：</label><input type="text" name="phone" maxlength="32" class="input td_contact fl" id="td_contact" size="35" required>
           </div>
        <div class="ap_input clearfix">
         <label class="ap_type fl" for="td_contact">留言：</label>
         <textarea name="message" style="width: 100%;height: 100px;" required="required"></textarea>
        </div> 
         <div class="ap_input clearfix">
         	<label class="ap_type fl" for="td_contact"></label>
        <button type="submit" class="btn_on">发送消息</button>
        </div>
        </form>
      <!--内容-->               
</div>
